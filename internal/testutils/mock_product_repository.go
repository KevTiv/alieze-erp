...
type MockProductRepository struct {
	...
	findAllFunc  func(ctx context.Context, filter domain.ProductFilter) ([]domain.Product, error)
	updateFunc   func(ctx context.Context, product domain.Product) (*domain.Product, error)
	deleteFunc   func(ctx context.Context, id uuid.UUID) error
	countFunc    func(ctx context.Context, filter domain.ProductFilter) (int, error)
}
...
func (m *MockProductRepository) FindByID(ctx context.Context, id uuid.UUID) (*domain.Product, error) {
	...
	return &domain.Product{ID: id, OrganizationID: uuid.Must(uuid.NewV7()), Name: "Test Product"}, nil
}
...
func (m *MockProductRepository) WithCreateFunc(f func(ctx context.Context, product domain.Product) (*domain.Product, error)) *MockProductRepository {
	m.createFunc = f
	return m
}

func (m *MockProductRepository) WithFindByIDFunc(f func(ctx context.Context, id uuid.UUID) (*domain.Product, error)) *MockProductRepository {
	m.findByIDFunc = f
	return m
}

func (m *MockProductRepository) WithFindAllFunc(f func(ctx context.Context, filter domain.ProductFilter) ([]domain.Product, error)) *MockProductRepository {
	m.findAllFunc = f
	return m
}

func (m *MockProductRepository) WithUpdateFunc(f func(ctx context.Context, product domain.Product) (*domain.Product, error)) *MockProductRepository {
	m.updateFunc = f
	return m
}
...
func (m *MockProductRepository) WithCountFunc(f func(ctx context.Context, filter domain.ProductFilter) (int, error)) *MockProductRepository {
	m.countFunc = f
	return m
}
